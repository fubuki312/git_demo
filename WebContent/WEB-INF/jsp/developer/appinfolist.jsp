								...
								<select name="queryStatus" class="form-control">
									<c:if test="${statusList != null }">
									   ...
									   <c:forEach var="dataDictionary" items="${statusList}">
									   		<option <c:if test="${dataDictionary.status == queryStatus }">selected="selected"</c:if>
									   		value="${dataDictionary.status}">${dataDictionary.statusName}</option>
									   </c:forEach>
									</c:if>
        						</select>
							</div>
								...
								<select name="queryFlatformId" class="form-control">
									<c:if test="${flatFormList != null }">
									   ...
									   <c:forEach var="dataDictionary" items="${flatFormList}">
									   		<option <c:if test="${dataDictionary.flatformId == queryFlatformId }">selected="selected"</c:if>
									   		value="${dataDictionary.flatformId}">${dataDictionary.flatformName}</option>
									   </c:forEach>
									</c:if>
        						</select>
							</div>
								...
								<select id="queryCategoryLevel1" name="queryCategoryLevel1" class="form-control">
									<c:if test="${categoryLevel1List != null }">
									   ...
									   <c:forEach var="appCategory" items="${categoryLevel1List}">
									   		<option <c:if test="${appCategory.categoryLevel1 == queryCategoryLevel1 }">selected="selected"</c:if>
									   		value="${appCategory.categoryLevel1}">${appCategory.categoryLevel1Name}</option>
									   </c:forEach>
									</c:if>
        						</select>
							</div>
        						...
        						<select name="queryCategoryLevel2" id="queryCategoryLevel2" class="form-control">
        							<c:if test="${categoryLevel2List != null }">
									   ...
									   <c:forEach var="appCategory" items="${categoryLevel2List}">
									   		<option <c:if test="${appCategory.categoryLevel2 == queryCategoryLevel2 }">selected="selected"</c:if>
									   		value="${appCategory.categoryLevel2}">${appCategory.categoryLevel2Name}</option>
									   </c:forEach>
									</c:if>
        						</select>
							</div>
        						...
        						<select name="queryCategoryLevel3" id="queryCategoryLevel3" class="form-control">
        							<c:if test="${categoryLevel3List != null }">
									   ...
									   <c:forEach var="appCategory" items="${categoryLevel3List}">
									   		<option <c:if test="${appCategory.categoryLevel3 == queryCategoryLevel3 }">selected="selected"</c:if>
									   		value="${appCategory.categoryLevel3}">${appCategory.categoryLevel3}</option>
									   </c:forEach>
									</c:if>
        						</select>
							</div>
